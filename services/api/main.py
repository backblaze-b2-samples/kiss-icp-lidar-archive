...
API_TITLE = "KISS-ICP LiDAR Archive API"
API_DESCRIPTION = (
    "Local API for KISS-ICP LiDAR Archive, a Backblaze B2 sample that ingests "
    "LiDAR scan frames, runs KISS-ICP SLAM on the backend, and streams "
    "odometry, incremental point-cloud maps, and trajectories to B2 over the "
    "S3-compatible API. This contract documents the local API, not a hosted "
    "public endpoint."
)
API_VERSION = "0.1.0"
