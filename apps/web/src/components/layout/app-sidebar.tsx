...
import { LayoutDashboard, Upload, FolderOpen, Settings, Sparkles, Radar } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const navItems = [
  ...
  { title: "Sessions", href: "/sessions", icon: Radar },
  ...
  return (
    <Sidebar>
      ...
      <SidebarFooter className="border-t border-sidebar-border px-4 py-3">
        <a
          href="https://www.backblaze.com/cloud-storage?utm_source=github&utm_medium=referral&utm_campaign=ai_artifacts&utm_content=b2ai-kiss-icp-lidar-archive"
          target="_blank"
